     ...
     <p class="title-style">
      ...
      <div class="forms">
            <el-row class="row">
              ...
              <el-col :span="2" :offset="1" class="txt">性别</el-col>
              <el-col :span="4">
            ...
            <el-row class="row">
              ...
              <el-col :span="2" :offset="1" class="txt">邮政编码</el-col>
              <el-col :span="4">
                <el-input size="mini" v-model.trim="form.acdgroup" maxlength="20" clearable></el-input>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="2" class="txt">备注</el-col>
   ...
   <div class="cars-info">
      <p class="title-style">
       ...
       <div class="box-border">
        ...
        <el-button size="mini" round type="primary" @click="showhistory" class="fr">显示历史</el-button>
   </div>
   <drawer ref="drawer">
...
import drawer from './customerInfotest2'
 ...
 methods: {
  open(e){
    ...
    showhistory(){
      // this.drawer=true
      let target=this.$refs.drawer.isheight;
      this.$refs.drawer.isheight=!target
      if(!target) this.$refs.drawer.mainsrcoll()
    },
    togglehistory(e){
