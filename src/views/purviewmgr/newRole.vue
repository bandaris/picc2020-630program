    ...
    <div class="content-info">
      <div class="">
        <el-row>
          ...
          <el-col :span="5">
            <el-input class="el-input-style" v-model.trim="dataInfo.rolename" size="mini"></el-input>
          </el-col>
          <el-col :span="2" :offset="3" class="txt">角色类型</el-col>
          <el-col :span="5">
            <el-select size="mini" v-model="dataInfo.roletype">
  ...
  methods: {
    ...
    infoDao(){
      ...
      if(target=='关闭'){
        ...
        console.log(this.dataInfo.rolename);
          let params={};
